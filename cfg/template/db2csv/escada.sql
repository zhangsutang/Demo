...
CREATE TABLE if not exists `wlddb`.`channel` (
	...
	`protocoltype` smallint(2) NOT NULL ,
	`subprotocoltype` smallint(2) NOT NULL ,
	`protocolpara` varbinary (128) NOT NULL ,
	`assocno` tinyint(1) NOT NULL ,
	`commonalarm` int(4) NOT NULL ,
	`attribute` int(4) NOT NULL ,
	`alarm` int(4) NOT NULL ,
	`statistic` int(4) NOT NULL ,
	PRIMARY KEY (`no`)
) ENGINE=InnoDB DEFAULT CHARSET='utf8';
...
CREATE TABLE if not exists `wlddb`.`rtu` (
	`channel` tinyint(1) NOT NULL DEFAULT 1,
	`no` smallint(2) NOT NULL  DEFAULT 1,
	`name` varchar (32) NOT NULL ,
	`desc` varchar (128) NOT NULL ,
	`address` int NOT NULL DEFAULT 1,
	`addrres` int NOT NULL DEFAULT 1,
	`type` varchar (32) NOT NULL ,
	`portpara` varbinary (256) NOT NULL ,
	`protocolpara` varbinary (256) NOT NULL ,
	`commonalarm` int ,
	`attribute` int NOT NULL  DEFAULT 0,
	`alarm` int NOT NULL DEFAULT 0x0a,
	`statistic` int NOT NULL DEFAULT 0,
...
CREATE TABLE if not exists `wlddb`.`yxcfg` (
	`station` tinyint(1) NOT NULL ,
	`no` int(4) NOT NULL ,
	`name` varchar (32) NOT NULL ,
	`desc` varchar (128) NOT NULL ,
	`channel` tinyint(1) NOT NULL ,
	`rtu` smallint(2) NOT NULL ,
	`address` int(4) NOT NULL ,
	`addrres` int(4) NOT NULL ,
	`powerbay` tinyint(1) NOT NULL ,
	`device` tinyint(1) NOT NULL ,
	`type` tinyint(1) NOT NULL ,
	`manualval` tinyint(1) NOT NULL ,
	`picture` varchar (64) NOT NULL ,
	`signno` tinyint(1) NOT NULL ,
	`attachpoint` int(4) NOT NULL ,
	`attribute` int(4) NOT NULL DEFAULT 4,
	`alarm` int(4) NOT NULL DEFAULT 0x0CA,
	`statistic` int(4) NOT NULL ,
...
CREATE TABLE if not exists `wlddb`.`yccfg` (
	...
	`back` real NOT NULL ,
	`picture` varchar(64) NOT NULL ,
	`storage` smallint(2) NOT NULL ,
	`storagesec` tinyint(1) NOT NULL ,
	`attachyx` int(4) NOT NULL ,
	`attribute` int(4) NOT NULL ,
	`alarm` int(4) NOT NULL ,
	`statistic` int(4) NOT NULL ,
	`volalarm` int(4) NOT NULL ,
	`volstatistic` int(4) NOT NULL ,
	PRIMARY KEY  (`station`,`no`),
...
CREATE TABLE if not exists `wlddb`.`ykcfg` (
	...
	`address` int(4) NOT NULL ,
	`addrres` int(4) NOT NULL ,
	`addroff` int(4) NOT NULL ,
	`addroffres` int(4) NOT NULL ,
	`powerbay` tinyint(1) NOT NULL ,
	`device` tinyint(1) NOT NULL ,
	`type` tinyint(1) NOT NULL ,
	`corrtype` tinyint(1) NOT NULL ,
	`corrno` int(4) NOT NULL ,
	`corrclose` int(4) NOT NULL ,
	`allowno` varbinary (8) NOT NULL ,
	`oprmax` tinyint(1) NOT NULL ,
	`oprtimes` tinyint(1) NOT NULL ,
	`delay` smallint(2) NOT NULL ,
	`lastime` datetime NOT NULL ,
	`attribute` int(4) NOT NULL ,
	`closedown` smallint(2) NOT NULL ,
	`alarm` smallint(2) NOT NULL ,
	PRIMARY KEY  (`station`,`no`),
...
CREATE TABLE if not exists `wlddb`.`powerbay` (
	...
	`name` varchar(32) NOT NULL ,
	`desc` varchar(128) NOT NULL ,
	`bus` smallint(2) NOT NULL ,
	`maindev` int(4) NOT NULL ,
	`plkg` int(4) NOT NULL ,
	`pldz` int(4) NOT NULL ,
	`pljg` tinyint(1) NOT NULL ,
	`signno` tinyint(1) NOT NULL ,
	`mainpt` int(4) NOT NULL ,
	`close` int(4) NOT NULL ,
	`picture` MEDIUMTEXT ,
	`attribute` int(4) NOT NULL ,
	PRIMARY KEY  (`station`,`no`),
...
CREATE TABLE if not exists `wlddb`.`syscfg` (
	`type` tinyint(1) NOT NULL ,
	`intervalrtdata` smallint(2) NOT NULL ,
	`intervalgraphic` smallint(2) NOT NULL ,
	`graphicmax` tinyint(1) NOT NULL ,
	`intervalpdr` tinyint(1) NOT NULL ,
	`beforepdr` tinyint(1) NOT NULL ,
	`afterpdr` tinyint(1) NOT NULL ,
	`fullalarmdb` tinyint(1) NOT NULL ,
	`fullalarmlog` tinyint(1) NOT NULL ,
	`safedaystart` datetime NOT NULL ,
	`attribute` int(4) NOT NULL ,
	`function` int(4) NOT NULL ,
	`alarmfunc` int(4) NOT NULL ,
	`alarmnet` int(4) NOT NULL ,
	`alarmnode` int(4) NOT NULL ,
	`alarmswitch` int(4) NOT NULL ,
...
CREATE TABLE if not exists `wlddb`.`mctimesharing` (
	...
	`no` tinyint(1) NOT NULL ,
	`type` tinyint(1) NOT NULL ,
	`begin` smallint(2) NOT NULL ,
	`end` smallint(2) NOT NULL ,
	PRIMARY KEY (`station`,`no`)
) ENGINE=InnoDB DEFAULT CHARSET='utf8';
...
CREATE TABLE if not exists `wlddb`.`pointtypecfg` (
	...
	`no` tinyint(1) NOT NULL ,
	`name` varchar(32) NOT NULL ,
	`glossarytype` tinyint(1) NOT NULL ,
...
CREATE TABLE if not exists `wlddb`.`pdrcfg` (
	`springtype` tinyint(1) NOT NULL ,
	`springstation` tinyint(1) NOT NULL ,
	`springno` int(4) NOT NULL ,
	`recordtype` tinyint(1) NOT NULL ,
	`recordstation` tinyint(1) NOT NULL ,
...
CREATE TABLE if not exists `wlddb`.`reporttimecfg` (
	...
	`minute` tinyint(1) NOT NULL ,
	`name` varchar(64) NOT NULL ,
	`maketime` datetime NOT NULL ,
	`printnum` tinyint(1) NOT NULL ,
	`attribute` tinyint(1) NOT NULL ,
	PRIMARY KEY (`station`,`type`,`no`)
) ENGINE=InnoDB DEFAULT CHARSET='utf8';
...
CREATE TABLE if not exists `wlddb`.`linecfg` (
	...
	`name` varchar(32) NOT NULL ,
	`desc` varchar(128) NOT NULL ,
	`generatrixno` smallint(2) NOT NULL ,
	`i0no` int(4) NOT NULL ,
	`i0signno` int(4) NOT NULL ,
	`attribute` tinyint(1) NOT NULL ,
	`reserve` varbinary(32) NOT NULL ,
	PRIMARY KEY (`station`,`no`)
) ENGINE=InnoDB DEFAULT CHARSET='utf8';
...
CREATE TABLE if not exists `wlddb`.`gsmcfg` (
	...
	`baud` int(4) NOT NULL ,
	`databit` tinyint(1) NOT NULL ,
	`stopbit` tinyint(1) NOT NULL ,
	`parity` tinyint(1) NOT NULL ,
	`smscenter` varchar(32) NOT NULL ,
	`attribute` int(4) NOT NULL ,
	`reserve` int(4) NOT NULL ,
	PRIMARY KEY (`no`)
) ENGINE=InnoDB DEFAULT CHARSET='utf8';
...
CREATE TABLE if not exists `wlddb`.`vqccfg` (
	...
	`check_time` tinyint(1) NOT NULL ,
	`exec_time` tinyint(1) NOT NULL ,
	`delay` smallint(2) NOT NULL ,
	`cap_interval` int(4) NOT NULL ,
	`tra_interval` int(4) NOT NULL ,
	`c_opr_vol` real NOT NULL ,
	`set_vol` varbinary(8) NOT NULL ,
	`set_cos` varbinary(8) NOT NULL ,
	`transf_attr` int(4) NOT NULL ,
...
CREATE TABLE if not exists `wlddb`.`fixvalcfg` (
	...
	`dataformat` tinyint(1) NOT NULL ,
	`datasize` tinyint(1) NOT NULL ,
	`unit` tinyint(1) NOT NULL ,
...
CREATE TABLE if not exists `wlddb`.`tyxcfg` (
	...
	`rtu` smallint(2) NOT NULL ,
	`address` int(4) NOT NULL ,
	`assocstation` tinyint(1) NOT NULL ,
	`assocno` int(4) NOT NULL ,
	`assoctype` tinyint(1) NOT NULL ,
	`name` varchar(32) NOT NULL ,
	`desc` varchar(128) NOT NULL ,
	`attribute` int(4) NOT NULL ,
	`alarm` int(4) NOT NULL ,
